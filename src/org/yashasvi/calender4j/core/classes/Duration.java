...
//
//            this.$24hr = 0;
//            this.$sec = hr * Constants.MICROSECONDS_IN_HOUR + min * Constants.MICROSECONDS_IN_MINUTE;
//        } catch (Exception e) {
//            // Bad Input
//        }
//    }
...
//        this.$sec = (minutes % Constants.MINUTES_IN_DAY) * Constants.MICROSECONDS_IN_MINUTE;
//    }
//
...
//        return this.$24hr * Constants.MICROSECONDS_IN_DAY + this.$sec;
//    }
//
//    public long minutesDiff() {
//        return this.$24hr * Constants.MINUTES_IN_DAY + this.$sec / Constants.MICROSECONDS_IN_MINUTE;
//    }
//
...
//        _hr = _hr + this.$sec / Constants.MICROSECONDS_IN_HOUR;
//        int _min = (int) (this.$sec % Constants.MICROSECONDS_IN_HOUR) / Constants.MICROSECONDS_IN_MINUTE;
//
