...
var ReactClassInterface = {
   ...
   *
   * Use this as an opportunity to reactjs to a prop transition by updating the
...
var ReactClass = {
  ...
  createClass: function (spec) {
    var Constructor = function (props, context, updater) {
      ...
      if ("development" !== 'production') {
        "development" !== 'production' ? warning(this instanceof Constructor, 'Something is calling a React component directly. Use a factory or ' + 'JSX instead. See: https://fb.me/reactjs-legacyfactory') : void 0;
      }
...
if ("development" !== 'production') {
  var deprecatedAPIs = {
    ...
    replaceState: ['replaceState', 'Refactor your code to use setState instead (see ' + 'https://github.com/facebook/reactjs/issues/3236).']
  };
  ...
  if (ExecutionEnvironment.canUseDOM && window.top === window.self) {
    ...
    if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ === 'undefined') {
      ...
      if (navigator.userAgent.indexOf('Chrome') > -1 && navigator.userAgent.indexOf('Edge') === -1 || navigator.userAgent.indexOf('Firefox') > -1) {
        ...
        console.debug('Download the React DevTools ' + (showFileUrlMessage ? 'and use an HTTP server (instead of a file: URL) ' : '') + 'for a better development experience: ' + 'https://fb.me/reactjs-devtools');
      }
    }

    var testFunc = function testFn() {};
    "development" !== 'production' ? warning((testFunc.name || testFunc.toString()).indexOf('testFn') !== -1, 'It looks like you\'re using a minified copy of the development build ' + 'of React. When deploying React apps to production, make sure to use ' + 'the production build which skips development warnings and is faster. ' + 'See https://fb.me/reactjs-minification for more details.') : void 0;
    ...
    for (var i = 0; i < expectedFeatures.length; i++) {
      if (!expectedFeatures[i]) {
        "development" !== 'production' ? warning(false, 'One or more ES5 shims expected by React are not available: ' + 'https://fb.me/reactjs-warning-polyfills') : void 0;
        break;
      }
    }
  }
...
function assertValidProps(component, props) {
  ...
  if (props.dangerouslySetInnerHTML != null) {
    ...
    !(typeof props.dangerouslySetInnerHTML === 'object' && HTML in props.dangerouslySetInnerHTML) ? "development" !== 'production' ? invariant(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. ' + 'Please visit https://fb.me/reactjs-invariant-dangerously-set-inner-html ' + 'for more information.') : invariant(false) : void 0;
  }
  if ("development" !== 'production') {
...
function precacheChildNodes(inst, node) {
  ...
  outer: for (var name in children) {
    ...
    for (; childNode !== null; childNode = childNode.nextSibling) {
      if (childNode.nodeType === 1 && childNode.getAttribute(ATTR_NAME) === String(childID) || childNode.nodeType === 8 && childNode.nodeValue === ' reactjs-text: ' + childID + ' ' || childNode.nodeType === 8 && childNode.nodeValue === ' reactjs-empty: ' + childID + ' ') {
...
_assign(ReactDOMEmptyComponent.prototype, {
  mountComponent: function (transaction, nativeParent, nativeContainerInfo, context) {
    ...
    var nodeValue = ' reactjs-empty: ' + this._domID + ' ';
    if (transaction.useCreateElement) {
      var ownerDocument = nativeContainerInfo._ownerDocument;
  ...
  mountWrapper: function (inst, props) {
    if ("development" !== 'production') {
      ...
      if (props.checked !== undefined && props.defaultChecked !== undefined && !didWarnCheckedDefaultChecked) {
        "development" !== 'production' ? warning(false, 'Input elements must be either controlled or uncontrolled ' + '(specify either the checked prop, or the defaultChecked prop, but not ' + 'both). Decide between using a controlled or uncontrolled input ' + 'element and remove one of these props. More info: ' + 'https://fb.me/reactjs-controlled-components') : void 0;
        didWarnCheckedDefaultChecked = true;
      }
      if (props.value !== undefined && props.defaultValue !== undefined && !didWarnValueDefaultValue) {
        "development" !== 'production' ? warning(false, 'Input elements must be either controlled or uncontrolled ' + '(specify either the value prop, or the defaultValue prop, but not ' + 'both). Decide between using a controlled or uncontrolled input ' + 'element and remove one of these props. More info: ' + 'https://fb.me/reactjs-controlled-components') : void 0;
...
var ReactDOMSelect = {
  ...
  mountWrapper: function (inst, props) {
    ...
    if (props.value !== undefined && props.defaultValue !== undefined && !didWarnValueDefaultValue) {
      "development" !== 'production' ? warning(false, 'Select elements must be either controlled or uncontrolled ' + '(specify either the value prop, or the defaultValue prop, but not ' + 'both). Decide between using a controlled or uncontrolled select ' + 'element and remove one of these props. More info: ' + 'https://fb.me/reactjs-controlled-components') : void 0;
      didWarnValueDefaultValue = true;
    }
  },
...
_assign(ReactDOMTextComponent.prototype, {
  ...
  mountComponent: function (transaction, nativeParent, nativeContainerInfo, context) {
    ...
    var domID = nativeContainerInfo._idCounter++;
    var openingValue = ' reactjs-text: ' + domID + ' ';
    var closingValue = ' /reactjs-text ';
    this._domID = domID;
    this._nativeParent = nativeParent;
    if (transaction.useCreateElement) {
      var ownerDocument = nativeContainerInfo._ownerDocument;
  ...
  getNativeNode: function () {
    ...
    if (!this._closingComment) {
      ...
      while (true) {
        ...
        if (node.nodeType === 8 && node.nodeValue === ' /reactjs-text ') {
  ...
  mountWrapper: function (inst, props) {
    if ("development" !== 'production') {
      ...
      if (props.value !== undefined && props.defaultValue !== undefined && !didWarnValDefaultVal) {
        "development" !== 'production' ? warning(false, 'Textarea elements must be either controlled or uncontrolled ' + '(specify either the value prop, or the defaultValue prop, but not ' + 'both). Decide between using a controlled or uncontrolled textarea ' + 'and remove one of these props. More info: ' + 'https://fb.me/reactjs-controlled-components') : void 0;
 ...
 * will work. Instead test $$typeof field against Symbol.for('reactjs.element') to check
        ...
        Object.defineProperty(props, 'key', {
          get: function () {
            if (!specialPropKeyWarningShown) {
              ...
              "development" !== 'production' ? warning(false, '%s: `key` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (https://fb.me/reactjs-special-props)', typeof type === 'function' && 'displayName' in type ? type.displayName : 'Element') : void 0;
            }
            return undefined;
          },
          configurable: true
        ...
        Object.defineProperty(props, 'ref', {
          get: function () {
            if (!specialPropRefWarningShown) {
              ...
              "development" !== 'production' ? warning(false, '%s: `ref` is not a prop. Trying to access it will result ' + 'in `undefined` being returned. If you need to access the same ' + 'value within the child component, you should pass it as a different ' + 'prop. (https://fb.me/reactjs-special-props)', typeof type === 'function' && 'displayName' in type ? type.displayName : 'Element') : void 0;
            }
            return undefined;
          },
          configurable: true
...
function getAddendaForKeyUse(messageType, element, parentType) {
  ...
  var addenda = {
    ...
    url: ' See https://fb.me/reactjs-warning-keys for more information.',
    childOwner: null
  };
 ...
 * but modified to be suitable for reactjs and has a couple of bug fixes (doesn't
...
var ReactMarkupChecksum = {
  CHECKSUM_ATTR_NAME: 'data-reactjs-checksum',
...
var ReactOwner = {
  ...
  addComponentAsRefTo: function (component, ref, owner) {
    !ReactOwner.isValidOwner(owner) ? "development" !== 'production' ? invariant(false, 'addComponentAsRefTo(...): Only a ReactOwner can have refs. You might ' + 'be adding a ref to a component that was not created inside a component\'s ' + '`render` method, or you have multiple copies of React loaded ' + '(details: https://fb.me/reactjs-refs-must-have-owner).') : invariant(false) : void 0;
  ...
  removeComponentAsRefFrom: function (component, ref, owner) {
    !ReactOwner.isValidOwner(owner) ? "development" !== 'production' ? invariant(false, 'removeComponentAsRefFrom(...): Only a ReactOwner can have refs. You might ' + 'be removing a ref to a component that was not created inside a component\'s ' + '`render` method, or you have multiple copies of React loaded ' + '(details: https://fb.me/reactjs-refs-must-have-owner).') : invariant(false) : void 0;
        ...
        return new Proxy(constructor.apply(that, args), {
          set: function (target, prop, value) {
            if (prop !== 'isPersistent' && !target.constructor.Interface.hasOwnProperty(prop) && shouldBeReleasedProperties.indexOf(prop) === -1) {
              "development" !== 'production' ? warning(didWarnForAddedNewProperty || target.isPersistent(), 'This synthetic event is reused for performance reasons. If you\'re ' + 'seeing this, you\'re adding a new property in the synthetic event object. ' + 'The property is never released. See ' + 'https://fb.me/reactjs-event-pooling for more information.') : void 0;
...
function getPooledWarningPropertyDefinition(propName, getVal) {
  ...
  function warn(action, result) {
    ...
    "development" !== 'production' ? warning(warningCondition, 'This synthetic event is reused for performance reasons. If you\'re seeing this, ' + 'you\'re %s `%s` on a released/nullified synthetic event. %s. ' + 'If you must keep the original synthetic event around, use event.persist(). ' + 'See https://fb.me/reactjs-event-pooling for more information.', action, propName, result) : void 0;
  }
}
